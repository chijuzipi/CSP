...
Scripts:
firefox-driver.py: the main script for capture the screenshots of webpages and measure the loading time of the page. The
captured images are saved to "screenshots" folder, the loading times are written to local file
...
2. configure your firefox browser to have two profiles, one with proxy another without it. Correlate the id of the
...
5. collect the screenshots images for differences processing
